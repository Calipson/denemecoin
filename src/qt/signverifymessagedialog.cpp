    ...
    model(0)
{
    ...
    ui->addressIn_SM->setPlaceholderText(tr("Enter a denemecoin address (e.g. N1KHAL5C1CRzy58NdJwp1tbLze3XrkFxx9)"));
    ui->signatureOut_SM->setPlaceholderText(tr("Click \"Sign Message\" to generate signature"));

    ui->addressIn_VM->setPlaceholderText(tr("Enter a denemecoin address (e.g. N1KHAL5C1CRzy58NdJwp1tbLze3XrkFxx9)"));
    ui->signatureIn_VM->setPlaceholderText(tr("Enter denemecoin signature"));
#endif
