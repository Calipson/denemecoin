...
How To Example for Bitcoin / Denemecoin
=====================================

This example assumes bitcoin RPC port is 8332 and denemecoin is at port 8331.

Compile denemecoind and bitcoind with the merged mining patch.  Then run:
