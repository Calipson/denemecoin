...
{
    resize(850, 550);
    setWindowTitle(tr("Denemecoin") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    manageNamesAction->setStatusTip(tr("Manage names registered via Denemecoin"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About Denemecoin"), this);
    aboutAction->setStatusTip(tr("Show information about Denemecoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for Denemecoin"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    if (!GetBoolArg("-testnet"))
    {
        trayIcon->setToolTip(tr("Denemecoin client"));
        trayIcon->setIcon(QIcon(":/icons/toolbar"));
    }
    else
    {
        trayIcon->setToolTip(tr("Denemecoin client") + QString(" ") + tr("[testnet]"));
        trayIcon->setIcon(QIcon(":/icons/toolbar_testnet"));
    }
    trayIcon->show();
#endif
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Denemecoin network", "", count));
}
...
{
    QString strTitle = tr("Denemecoin") + " - ";
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            message(tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Denemecoin address or malformed URI parameters."),
