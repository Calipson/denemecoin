...
// everywhere (and called just CSecret); in the current Denemecoin implementation it is only used for
...
// Note: Denemecoin implementation uses a hack: CSecret32 is used here, everywhere else
